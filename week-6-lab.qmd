...
ggplot(likelihood_dem, aes(beta0, beta1, fill = negloglik)) +
  geom_raster() +
  geom_point(x = -2.422124762, y = 0.004398142, color = "red")
...
```{r}
interaction_glm <- glm(violations ~ pcthisp + medianincomehouse + pcthisp : medianincomehouse, 
                   family = binomial(link = "logit"),
                   data = drinking_water)
